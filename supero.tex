...
\todo{Separate into three different generalisation strategies. Give much better intuition. Three subsubsection headings, Shell only; MSG; bowtie}
...
\todo{Say what is the difference between supercompilation and partial evaluation. Answer is that partial evaluation is more focused on binding times, particularly at removing interpretation overhead. There are lots of different definitions of exactly what each one does.}
