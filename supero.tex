...
\todo{Discuss and improve compile time performance}

\todo{Give examples of generalisation}
...
drive(rho, x)
    if terminate\!!(rho, x) then
        ...
        {-" \textsf{\textbf{return }} "-} gen\!!(map (tie rho) cs)
    else
...
unfolds x =  [gen (cs |+ (i, y))
             |let (cs, gen) = uniplate x
             ,(i,c) <- zip [0..] cs, y <- unfolds c]
...
\begin{tabular}{@@{}r@@{ $\unlhd$ }l@@{\hspace{7mm}(}l@@{, }l@@{, }l@@{)\hspace{7mm} |let|\hspace{1mm}}l@@{\hspace{1mm}|in|\hspace{1mm}}l}
\multicolumn{2}{l}{\hspace{-2mm}Embedding} & \multicolumn{3}{l}{\hspace{-3mm}msg} & \multicolumn{2}{l}{\hspace{-8mm}$\bowtie$} \vspace{2mm} \\
