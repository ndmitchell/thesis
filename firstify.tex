...
Given an expression |v (\v' -> x)|, the variable |v| must evaluate to |undefined|. First assume that there exists a lambda expression within the program that has not been removed, it must be the...
\end{lemma}
