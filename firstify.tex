...
\begin{example}
\textit{The pretty and constraints programs} both apply a functional value to an expression that evaluates to |undefined| and apply a functional value \todo{unclear}. The case in \textit{pretty} comes from the fragment:
