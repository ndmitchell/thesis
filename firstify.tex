...
The specialisation transformation makes use of the notion of templates.
...
\
 ...
 When a function is specialised, the expression passed as the unsaturated argument has all its free variables passed as extra arguments, and is expanded in the specialised version. The specialisation proceeds in three steps:
...
\subsection{Comparison to Catch 05}
