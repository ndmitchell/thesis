...
\todo{Make this closer to the Core language in the background section. In particular, define alts in terms of patterns, move the description of arity etc into the background, define as a modification on the existing one.}

\begin{figure}
\ignore\begin{code}
prog   =  f |--> (vs_,expr){-"\text{\hspace{1cm}program definition}"-}
...
& \multicolumn{8}{l} ...plus 35 tests from the spectral suite... \\
