...
\subsection{Termination Bound (Bound in Table \ref{tabF:results})}
...
\subsection{Creating of Functional Values (HO Create in Table \ref{tabF:results})}
...
\subsection{Uses of Functional Values (HO Use in Table \ref{tabF:results})}
...
\subsection{Execution Time (Time in Table \ref{tabF:results})}
\label{secF:time}
...
\subsection{Program Size (Size in Table \ref{tabF:results})}
