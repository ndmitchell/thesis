...
In this chapter we introduce the background material and general notations used throughout the rest of this thesis. We start by introducing a Core language in \S\ref{sec:core}, then discuss the semantics of this Core language in \S\ref{sec:semantics}, including its sharing properties in \S\ref{sec:sharing}. We then cover the homeomorphic embedding operator in \S\ref{sec:homeomorphic}, particularly applied to the expression type of this Core language.

\section{Core Language}
\label{sec:core}

\todo{Unify Core language}
