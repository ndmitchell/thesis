...
The Proof of Pattern-Match Analysis Appendix (\ref{chp:proof}) provides a proof that the algorithms presented in chapter \ref{chp:catch} ensure pattern-match safety, given certain properties of the constraint language. It then proves that two of the constraint languages satisfy the necessary properties.
