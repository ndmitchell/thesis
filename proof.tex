...
sat' $ (c <| []) /# ([0..],xs) ==> False
    -- inline | <|| |
sat' $ (propOrs $ map f []) /# ([0..],xs) ==> False
    -- inline |map|
sat' $ propOrs [] /# ([0..],xs) ==> False
    -- inline |propOrs|
sat' $ propFalse /# ([0..],xs) ==> False
    -- inline |(/)|
sat' $ propFalse ==> False
    -- inline |sat'|
False ==> False
...
Note to self: We cannot induct on |k| as it is a list of |Val|.
...
sat' $ (c <| map f_rhd k) /# ([0..],xs) ==> sat $ Sat (xs !! i) k
    -- inline | <|| |
sat' $ orP (map f_lhd (map f_rhd k)) /# ([0..],xs) ==> sat $ Sat (xs !! i) k
    -- |map f . map g = map (f . g)
sat' $ orP (map (f_lhd . f_rhd) k) /# ([0..],xs) ==> sat $ Sat (xs !! i) k
\end{code}
