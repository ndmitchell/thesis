...
\theorem{sat/any}
{\h{#mp}|sat (Sat (Val c xs) ks) == any (\k -> sat $ Sat (Val c xs) [k]) ks|}

\theorem{sat/merge}
{\h{#mp}|sat $ Sat (Val c xs) [merge ms_1 ms_2 :* merge ms_1 ms_2] ==> sat $ Sat (Val c xs) [ms_1 :* ms_2]|}

\proof{sat/any}

\h{#mp exprlist}\begin{code}
sat (Sat (Val c xs) ks) == any (\k -> sat $ Sat (Val c xs) [k]) ks
    -- inline |sat|
sat' ((c <| ks) /# ([0..],xs)) == rhs
    -- inline | <|| |
...
any (\k -> sat' $ f k /# ([0..],xs)) ks == rhs
    -- insert RHS
any (\k -> sat' $ f k /# ([0..],xs)) ks == any (\k -> sat $ Sat (Val c xs) [k]) ks
    -- unwrap common parts
sat' (f k /# ([0..],xs)) == sat (Sat (Val c xs) [k])
    -- inline |sat|
lhs == sat' ((c <| [k]) /# ([0..],xs))
    -- inline | <|| |
...
\h{#mp exprlist}\begin{code}
sat $ Sat (Val c xs) [merge ms_1 ms_2 :* merge ms_1 ms_2] ==> sat $ Sat (Val c xs) [ms_1 :* ms_2]
    -- inline |sat|
