...
\begin{figure}
\def{Prop,propAnd,propOr,propAnds,propOrs,propMap,propTrue,propFalse,propBool,propLit}
\h{.*}\begin{code}
data Prop alpha
...
\begin{figure}
\def{Constraint,:-,RegExp,RegItem,Atom,Star,-<,||>,<||,ewp,integrate,differentiate}
\h{.re}\begin{code}
...
\begin{figure}
\def{Constraint,Val,Pattern,:*,Any,Pattern,nonRecs,complete,-<,||>,<||,mergeVal,merge}
\h{.mp}\begin{code}
type Constraint  =  [Val]
