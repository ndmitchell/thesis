...
In order to evaluate an expression to normal form, it is necessary for the expression to be closed and for evaluation of the expression to terminate. Provided the expression |e| can be evaluated to normal form, and that both |e| and the program under analysis are first-order Core as described in \S\ref{secC:catch_core}, then we prove the soundness theorem in Appendix \ref{chp:proof}.
