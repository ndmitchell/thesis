...
\begin{figure}
\ind{Str,Zero,One,Two,strList,listStr}
\h{.*}\begin{code}
...
\begin{figure}
\ind{children,universe,descend,transform,rewrite,descendM,transformM,rewriteM,para,holes,contexts}
\begin{code}
children :: Uniplate alpha => alpha -> [alpha]
...
\ind{childrenOn,universeOn,descendOn,transformOn}
\begin{code}
...
\begin{figure}
\indd{PlateTypeable,plateAll,PlateAll,Type,plate,||+,plateSome}
