...
\begin{exampleany}{Example from \S\ref{sec:uniplate_introduction} (revisited)}
...
The results are presented in Table \ref{tab:uniplate_results}. Using Manual or Direct instances, Uniplate is roughly the same speed as Compos -- but about 50\% slower than hand-optimised versions. Using the Data instances provided by SYB, we are able to outperform SYB itself! See \S\ref{sec:performance} for details of some of the optimisations used.
